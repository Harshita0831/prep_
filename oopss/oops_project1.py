...
class BankAccount:
    def __init__(self,acc_no,name,balance):
        self.acc_no = acc_no
        self.name = name
        self._balance = balance   #representing current object
    ...
    def get_balance(self):
        return self._balance
    def calculate_interest(self):       #abstract class - meyhod body not method
        pass
...
class CurrentAccount(BankAccount):          #polymorphism
    def calculate_interest(self):
        return 0
...
app = BankApp()
print(app.create_account(111,"Henry",10000,"savings"))
